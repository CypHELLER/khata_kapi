...
class AddPurchasedItem extends StatefulWidget {
  const AddPurchasedItem({super.key});

  @override
  State<AddPurchasedItem> createState() => _AddPurchasedItemState();
}
              ...
              child: ElevatedButton.icon(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const SelectPurchaseItem(),
                          ),
                        );
                      },
